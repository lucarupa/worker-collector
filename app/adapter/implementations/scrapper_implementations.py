...
class ScrapperImplementations(StrategyModel):
    def __init__(self, data: StrategyInterface):
        super().__init__(data)
        self.config: ScrapperConfigInterface = data.config
        self.logger = AppLogger("Scrapper Implementations", "app.log").get_logger()
